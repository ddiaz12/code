<div class="form-step" id="step-1"></div>
    ...
    <div class="form-group"></div>
        ...
        <div id="especificarDirigidaA" style="display: none;"></div>
    ...
    <div class="form-group"></div>
        ...
        <div id="especificarRealizadaEn" style="display: none;"></div>
            <label>Otros:</label>
    ...
    <div class="form-group"></div>
        ...
        <select name="Periodicidad" class="form-control" required></select>
            <option value="">Selecciona</option>
