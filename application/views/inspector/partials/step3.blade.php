...
<div id="step-3" class="form-step">
    <h3 class="card-title" style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">No
        publicidad</h3>
    <h5 class="alert alert-warning"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Determina la información de la ficha del Inspector(a) que no se puede publicar en el portal
                        ciudadano:</label>
                    <select class="form-control" name="datos_no_publicar[]" multiple>
                        ...
                        <option value="primer_apellido" <?php echo isset($inspector->datos_no_publicar) && in_array('primer_apellido', $inspector->datos_no_publicar) ? 'selected' : ''; ?>>Primer
                            Apellido</option>
                        <option value="segundo_apellido" <?php echo isset($inspector->datos_no_publicar) && in_array('segundo_apellido', $inspector->datos_no_publicar) ? 'selected' : ''; ?>>Segundo
                            Apellido</option>
                        <option value="fotografia" <?php echo isset($inspector->datos_no_publicar) && in_array('fotografia', $inspector->datos_no_publicar) ? 'selected' : ''; ?>>Fotografía
                        </option>
