            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-step" id="step-1">
                        <h3 class="card-title" style="background-color: #8E354A; color: white; padding: 10px;">Datos de identificación de Inspector(a), Verificador(a) y Visitador(a) Domiciliario(a)</h3>
                        <div class="alert alert-warning">
                            <h5 style="color: black;">Atención: Esta ficha debe ser requisitada con el uso de letras mayúsculas y minúsculas.</h5>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="telefono_oficial">Número telefónico oficial <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="correo_oficial">Correo electrónico oficial <span class="text-danger">*</span></label>
                            <?php echo form_input(['name' => 'correo_oficial', 'id' => 'correo_oficial', 'class' => 'form-control', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="domicilio_dependencia">Domicilio de la dependencia al que está inscrito <span class="text-danger">*</span></label>
                            <?php echo form_input(['name' => 'domicilio_dependencia', 'id' => 'domicilio_dependencia', 'class' => 'form-control', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="documento_cargo">Documento que acredite cargo o nombramiento (JPG, PNG o PDF) <span class="text-danger">*</span></label>
                            <?php echo form_upload(['name' => 'documento_cargo', 'id' => 'documento_cargo', 'class' => 'form-control-file', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="vigencia_cargo">Vigencia del cargo o nombramiento <span class="text-danger">*</span></label>
                            <?php echo form_input(['name' => 'vigencia_cargo', 'id' => 'vigencia_cargo', 'class' => 'form-control', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="inspecciones_asociadas">Asociar servidor público con una o más inspecciones, visita domiciliarias o verificaciones <span class="text-danger">*</span></label>
                            <?php echo form_input(['name' => 'inspecciones_asociadas', 'id' => 'inspecciones_asociadas', 'class' => 'form-control', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="nombre_inspeccion">Nombre de la inspección <span class="text-danger">*</span></label>
                            <?php echo form_input(['name' => 'nombre_inspeccion', 'id' => 'nombre_inspeccion', 'class' => 'form-control', 'required' => 'required']); ?>
                        </div>
                        
                        <div class="form-group">
                            <label for="inspecciones_facultadas">Inspecciones, verificaciones o visitas domiciliarias que está facultado para realizar <span class="text-danger">*</span></label>
