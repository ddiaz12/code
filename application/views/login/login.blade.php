				...
				<div class="col-md-7 col-lg-5">
		            ...
		            <div class="form-group d-md-flex">
		            	<div class="w-50 text-left">
									<p class="text-center"><a data-toggle="tab" href="http://localhost/code-main/Usuarios/agregar_usuario" id="regis">Registrarse</a></p>
									</div>
									<div class="w-50 text-md-right">
										<a href="http://localhost/code-main/auth/forgot" id="forgot">¿Has olvidado tu contraseña?</a>
									</div>
		            </div>
		          </form>
