                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" id="formUnidad">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputNombre" name="inputNombre" placeholder="Nombre completo" value="{{ $unidades->nombre }}" required>
                            <small id="msg_inputNombre" class="text-danger"></small>
                        </div>
                        <div class="col-md-6">
                            <label for="inputSiglas">Siglas<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="inputSiglas" name="siglas" value="{{ $unidades->siglas }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputVialidad" name="nombre_vialidad" value="{{ $unidades->nombre_vialidad }}">
                            <small id="msg_nombre_vialidad" class="text-danger"></small>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumInterior">Número interior</label>
                                <input type="number" class="form-control" id="inputNumInterior" name="num_interior" value="{{ $unidades->Num_interior }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumExterior">Número exterior<span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="inputNumExterior" name="num_exterior" value="{{ $unidades->Num_Exterior }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="selectLocalidad" name="localidad" required>
                                    ...
                                    <option value="{{ $localidad->ID_localidad }}" {{ $localidad->ID_localidad == $unidades->ID_localidad ? 'selected' : '' }} data-clave="{{ $localidad->clave }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="claveLocalidad" name="clave_localidad" value="{{ $localidad->clave }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="inputCP" name="codigo_postal" value="{{ $unidades->c_p }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" value="{{ $unidades->NumTel_Oficial }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="inputExtension" name="extension" value="{{ $unidades->extension }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="Email" name="email" value="{{ $unidades->Correo_Elec }}" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="checkboxOficina" name="checkboxOficina" {{ $unidades->checkOficina ? 'checked' : '' }}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger eliminar" data-id="{{ $horario->ID_Horario }}">Eliminar</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-guardar" data-bs-toggle="modal" data-bs-target="#modalAgregarHorario">
                                Agregar Horario
                            </button>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mb-3">
                            ...
                            <button type="button" onclick="enviarFormulario();" class="btn btn-success btn-guardar">Actualizar</button>
                        </div>
                    </form>
                </div>
            </div>
