        ...
        echo '<button class="list-group-item list-group-item-action wizard-step" data-step="' . $stepNumber . '">
            ...
            <div class="col-md-9 main-content">
                ...
                <div class="form-container">
                    <form id="inspeccionForm" method="post" action="<?= base_url('Agregarinspeccion/guardar'); ?>"
                        enctype="multipart/form-data">
                        <input type="hidden" name="id_inspeccion"
                            value="{{ isset($inspeccion) ? $inspeccion->id_inspeccion : '' }}">
                        <!-- Campo 1: Datos de identificación -->
                        <div class="form-step" id="step-1">
                            <h3 class="card-title"
                                style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">
                            ...
                            <div class="form-group">
                                <label><b>Tipo de inspección, verificación o visita domiciliaria</b><span
                                ...
                                <select name="Tipo_Inspeccion" class="form-control" required>
                                    ...
                                    <option value="Corroboración" {{ isset($inspeccion) && $inspeccion->Tipo_Inspeccion == 'Corroboración' ? 'selected' : '' }}>Corroboración
                                    </option>
                                    ...
                                    <option value="Supervisión" {{ isset($inspeccion) && $inspeccion->Tipo_Inspeccion == 'Supervisión' ? 'selected' : '' }}>Supervisión
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <p style="font-size: 14px;">
                                    ¿La inspección, verificación o visita domiciliaria se encuentra exenta de la Ley de
                                    Fomento a la Confianza Ciudadana?<span class="text-danger">*</span>
                                </p>
                                <div>
                                ...
                                <div id="justificarLeyFomento" style="display: none;">
                                    <label>
                                        Justificar si la inspección, verificación o visita domiciliaria son sujetas para
                                        todas o algunas de sus modalidades a suspensión conforme lo establecido en el
                                        artículo 1 y 13 de la Ley de Fomento a la Confianza Ciudadana:<span
                            ...
                            <div class="form-group">
                                <label><b>¿La inspección, verificación o visita domiciliaria va dirigida a personas físicas,
                                        morales o ambas?</b><span class="text-danger">*</span></label>
                                <select name="Dirigida_A" class="form-control" required>
                                    ...
                                    <option value="Físicas con actividad empresarial" {{ isset($inspeccion) && $inspeccion->Dirigida_A == 'Físicas con actividad empresarial' ? 'selected' : '' }}>
                                        Personas físicas con actividad empresarial</option>
                                ...
                                <div id="especificarDirigidaA" style="display: none;">
                                    <label>Indicar a quién va dirigida la inspección, verificación o visita
                                        domiciliaria:</label>
                                    {{ form_input(['name' => 'Especificar_Dirigida_A', 'class' => 'form-control', 'value' => isset($inspeccion) ? $inspeccion->Especificar_Dirigida_A : '']) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label><b>La inspección, verificación o visita domiciliaria es:</b><span
                                        class="text-danger">*</span></label>
                                <select name="Caracter_Inspeccion" class="form-control" required>
                                    <option value="">Selecciona</option>
                                    <option value="PREVENTIVA" {{ isset($inspeccion) && $inspeccion->Caracter_Inspeccion == 'PREVENTIVA' ? 'selected' : '' }}>PREVENTIVA (se
                                        realiza para prevenir algún impacto negativo)</option>
                                    <option value="REACTIVA" {{ isset($inspeccion) && $inspeccion->Caracter_Inspeccion == 'REACTIVA' ? 'selected' : '' }}>REACTIVA (como
                                        respuesta a un accidente o amenaza particular)</option>
                                    <option value="SEGUIMIENTO" {{ isset($inspeccion) && $inspeccion->Caracter_Inspeccion == 'SEGUIMIENTO' ? 'selected' : '' }}>SEGUIMIENTO (se
                                        da seguimiento al cumplimiento de alguna obligación en particular)</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label><b>Indique si la verificación, inspección o visita domiciliaria se realiza
                                        en:</b><span class="text-danger">*</span></label>
                                <select name="Realizada_En" class="form-control" required>
                                    <option value="">Selecciona</option>
                                    <option value="Domicilio" {{ isset($inspeccion) && $inspeccion->Realizada_En == 'Domicilio' ? 'selected' : '' }}>En el domicilio o
                                        establecimientos de los Sujetos Regulados</option>
                                    ...
                                    <option value="Electronicos" {{ isset($inspeccion) && $inspeccion->Realizada_En == 'Electronicos' ? 'selected' : '' }}>Medios electrónicos
                                    </option>
                            ...
                            <div class="form-group">
                                <label><b>¿Cuál es el objetivo de la inspección, verificación o visita
                                        domiciliaria?</b><span class="text-danger">*</span></label>
                                {{ form_textarea(['name' => 'Objetivo', 'class' => 'form-control', 'rows' => 3, 'required' => true, 'value' => isset($inspeccion) ? $inspeccion->Objetivo : '']) }}
                            </div>
                            <div class="form-group">
                                <label><b>Palabras clave que describan o identifiquen las inspecciones, verificaciones y
                                        visitas domiciliarias:</b><span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="Periodicidad" class="form-control" required>
                                    ...
                                    <option value="Trineal o más" {{ isset($inspeccion) && $inspeccion->Periodicidad == 'Trineal o más' ? 'selected' : '' }}>Trineal o más
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="Motivo_Inspeccion" class="form-control" required>
                                    ...
                                    <option value="Extraordinaria" {{ isset($inspeccion) && $inspeccion->Motivo_Inspeccion == 'Extraordinaria' ? 'selected' : '' }}>Extraordinaria
                                    </option>
                                    <option value="De oficio" {{ isset($inspeccion) && $inspeccion->Motivo_Inspeccion == 'De oficio' ? 'selected' : '' }}>De oficio</option>
                                    <option value="A solicitud de parte" {{ isset($inspeccion) && $inspeccion->Motivo_Inspeccion == 'A solicitud de parte' ? 'selected' : '' }}>A
                                        solicitud de parte</option>
                            ...
                            <div class="form-group">
                                <label><b>Nombre de trámite o servicio asociado en esta inspección, verificación o visita
                                        domiciliaria:</b><span class="text-danger">*</span></label>
                                <div>
                            ...
                            <div class="form-group">
                                <label><b>¿Existe un fundamento jurídico que dé origen a la inspección, verificación o
                                        visita domiciliaria?</b><span class="text-danger">*</span></label>
                                <div>
                                ...
                                <div id="fundamentoJuridico" style="display: none;">
                                    ...
                                    <select name="Tipo_Fundamento_Juridico" class="form-control">
                                        ...
                                        @foreach($tipos_fundamento_juridico as $tipo)
                                            <option value="{{ $tipo->id }}" {{ isset($inspeccion) && $inspeccion->Tipo_Fundamento_Juridico == $tipo->id ? 'selected' : '' }}>
                                                {{ $tipo->nombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-step" id="step-2">
                            ...
                            <div id="oficinasModal" class="modal fade" tabindex="-1" role="dialog"
                                aria-labelledby="oficinasModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="oficinasModalLabel">Seleccionar Oficina
                                                Administrativa</h5>
                                                    ...
                                                    @if(isset($oficinas) && count($oficinas) > 0)
                                                        @foreach($oficinas as $oficina)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button"
                                                                        class="btn btn-primary seleccionarOficinaBtn"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary"
                                                id="aceptarOficinaBtn">Aceptar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-step" id="step-3">
                            <h3 class="card-title"
                                style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">
                                Información sobre la inspección</h3>
                            <h5 class="alert alert-warning" style="color: grey; font-size: 14px; padding: 10px; margin: 0;">
                                Atención: Esta ficha debe ser requisitada con el uso de letras mayúsculas y minúsculas.
                            </h5>
                            <div class="form-group">
                                <label>Bien, elemento, objeto o sujeto de inspección, verificación o visita
                                    domiciliaria:<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label>Indicar si otros Sujetos Obligados participan en la realización de las inspecciones,
                                    verificaciones y visitas domiciliarias:<span class="text-danger">*</span></label>
                            ...
                            <div id="sujetosModal" class="modal fade" tabindex="-1" role="dialog"
                                aria-labelledby="sujetosModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                ...
                                                <tbody>
                                                    @foreach($sujetos_obligados as $sujeto)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                    class="btn btn-primary seleccionarSujetoBtn"
                                                                    data-sujeto="{{ $sujeto->nombre_sujeto }}">Seleccionar</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Salir</button>
                                            <button type="button" class="btn btn-primary"
                                                id="aceptarSujetoBtn">Aceptar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Derechos del sujeto regulado durante la inspección, verificación o visita
                                    domiciliaria</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label>Fundamento Jurídico de la existencia de la inspección, verificación o visita
                                    domiciliaria:<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" name="Nombre_Fundamento" class="form-control" placeholder="Nombre"
                                        required>
                            ...
                            <div class="form-group">
                                <label>Especificar si el sujeto regulado debe llenar o firmar algún formato para la
                                    inspección, verificación o visita domiciliaria:<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="form-step" id="step-4">
                            <h3 class="card-title"
                                style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">Más
                                detalles</h3>
                            <h5 class="alert alert-warning" style="color: grey; font-size: 14px; padding: 10px; margin: 0;">
                                Atención: Esta ficha debe ser requisitada con el uso de letras mayúsculas y minúsculas.
                            </h5>
                            <div class="form-group">
                                <label>¿Tiene algún costo o pago de derechos, productos y aprovechamientos aplicables?<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="form-group" id="costoDetails" style="display: none;">
                                ...
                                <label>¿El monto se encuentra fundamentado jurídicamente?<span
                                        class="text-danger">*</span></label>
                                ...
                                <div id="fundamentoDetails" style="display: none;">
                                    ...
                                    <input type="text" name="Nombre_Fundamento_Costo" class="form-control"
                                        placeholder="Nombre">
                            ...
                            <div class="form-group">
                                <label><b>Pasos a realizar por el inspector o verificador durante la inspección,
                                        verificación o visita domiciliaria:</b></label>
                                <p style="color: grey;">
                                    Aproximadamente, ¿Cuánto tiempo lleva la verificación en todas sus etapas –orden,
                                    diligencia y resolución-? Indique y desglose lo más posible los pasos realizados:
                                </p>
                                <textarea name="Pasos_Inspector" class="form-control" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Tramites vinculados a la inspección, verificación o visita domiciliaria<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="Nombre_Tramite_Vinculado" class="form-control"
                                    placeholder="Nombre del tramite">
                                <input type="url" name="Url_Tramite_Vinculado" class="form-control"
                                    placeholder="URL del tramite">
                            </div>
                            <div class="form-group">
                                <label>Regulaciones que debe cumplir el sujeto obligado</label>
                                <input type="text" name="Nombre_Regulacion" class="form-control"
                                    placeholder="Nombre de la regulación">
                                <input type="url" name="Url_Regulacion" class="form-control"
                                    placeholder="URL de la regulación">
                            </div>
                            <div class="form-group">
                                <label>Requisitos o documentos que debe presentar el interesado</label>
                                <input type="file" name="Requisitos_Documentos" class="form-control-file"
                                    accept=".pdf,.jpg,.png">
                            </div>
                            <div class="form-group">
                                <label>¿Qué tipo de sanciones pueden derivar a partir de esta inspección?<span
                                        class="text-danger">*</span></label>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="Sanciones[]"
                                        value="Clausura definitiva">
                                    <label class="form-check-label">Clausura definitiva</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="Sanciones[]"
                                        value="Clausura temporal">
                                ...
                                <div class="form-check">
                                    ...
                                    <input type="text" name="Otra_Sancion" class="form-control mt-2"
                                        placeholder="Especificar otra sanción">
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="Sanciones[]"
                                        value="Revocación de licencia, permiso, autorización u otro">
                                    <label class="form-check-label">Revocación de licencia, permiso, autorización u
                                        otro</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="Sanciones[]"
                                        value="Suspensión definitiva de actividades">
                                    <label class="form-check-label">Suspensión definitiva de actividades</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="Sanciones[]"
                                        value="Suspensión temporal de actividades">
                            ...
                            <div class="form-group">
                                <label>Tiempo aproximado de la inspección, verificación o visita domiciliaria<span
                                        class="text-danger">*</span></label>
                                <input type="number" name="Valor_Plazo" class="form-control" placeholder="Valor del plazo"
                                    min="1">
                            ...
                            <div class="form-group">
                                <label>Facultades, atribuciones y obligaciones del Sujeto Obligado que la realiza<span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label>Servidores públicos facultados para realizar la inspección, verificación o visita
                                    domiciliaria</label>
                                <input type="text" name="Nombre_Servidor_Publico" class="form-control" placeholder="Nombre">
                                <input type="url" name="Url_Servidor_Publico" class="form-control"
                                    placeholder="URL directo a su ficha">
                            </div>
                        </div>
                        ...
                        <div class="form-step" id="step-5">
                            <h3 class="card-title"
                                style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">
                                Información de la Autoridad Pública y Contacto</h3>
                            <h5 class="alert alert-warning" style="color: grey; font-size: 14px; padding: 10px; margin: 0;">
                                Atención: Esta ficha debe ser requisitada con el uso de letras mayúsculas y minúsculas.
                            </h5>
                            <div class="form-group">
                                <label>Números telefónicos</label>
                                <input type="text" name="Numeros_Telefonicos" class="form-control"
                                    placeholder="Números telefónicos">
                            </div>
                            <div class="form-group">
                                <label>Dirección y correo electrónico de los órganos internos de control o equivalentes para
                                    realizar denuncias</label>
                                <input type="text" name="Direccion_Organos_Control" class="form-control"
                                    placeholder="Dirección">
                                <input type="email" name="Correo_Organos_Control" class="form-control"
                                    placeholder="Correo electrónico">
                            </div>
                            <div class="form-group">
                                <label>Señalamiento de los medios de impugnación con los que cuenta el interesado que se
                                    inconforme con la inspección, verificación o visita domiciliaria:<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="Nombre_Regulacion_Impugnacion" class="form-control"
                                    placeholder="Nombre de la regulación">
                                <input type="text" name="Articulo_Regulacion_Impugnacion" class="form-control"
                                    placeholder="Artículo">
                                <input type="text" name="Parrafo_Regulacion_Impugnacion" class="form-control"
                                    placeholder="Párrafo, número o numeral">
                                <input type="url" name="Url_Regulacion_Impugnacion" class="form-control"
                                    placeholder="URL de la regulación">
                            </div>
                        </div>
                        ...
                        <div class="form-step" id="step-6">
                            ...
                            <h8 class="mb-3">¿Cuántas inspecciones se realizaron en el año anterior por mes?<span
                                    class="text-danger">*</span></h8>
    ...
    foreach ($meses as $fila) {
        ...
        echo '</div>';
                            ...
                            <div class="form-group mt-4">
                                <label>¿Cuántas inspecciones derivaron en sanción en el año inmediato anterior?<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="form-step" id="step-7">
                            ...
                            <div class="form-group">
                                <label>Información que se considere útil para que el interesado realice la inspección,
                                    verificación o visita domiciliaria:</label>
                        ...
                        <div class="form-step" id="step-8">
                            <h3 class="card-title"
                                style="background-color: #8E354A; color: white; padding: 10px; border-radius: 10px;">No
                                publicidad</h3>
                            <h5 class="alert alert-warning" style="color: grey; font-size: 14px; padding: 10px; margin: 0;">
                                Atención: Esta ficha debe ser requisitada con el uso de letras mayúsculas y minúsculas.
                            </h5>
                            <div class="form-group">
                                <label>¿Permitir que todos los datos de la inspección, verificación o visita domiciliaria
                                    sea pública?<span class="text-danger">*</span></label>
                            ...
                            <div id="noPublicidadDetails" style="display: none;">
                                <div class="form-group">
                                    <label>Cargar un documento por medio del cual el sujeto obligado justifique que no se
                                        puede publicar la información de sus inspectores, verificadores y visitadores y/o
                                        inspecciones, verificaciones y visitas domiciliarias.<span
                                            class="text-danger">*</span></label>
                                    <input type="file" name="Documento_No_Publicidad" class="form-control-file"
                                        accept=".pdf,.jpg,.png">
                                </div>
                                <div class="form-group">
                                    <label>Determina la información de la ficha de la inspección, verificación o visita
                                        domiciliaria que no se puede publicar en el portal ciudadano:</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="No_Publicar[]"
                                            value="Datos de identificación de la inspección">
                                        <label class="form-check-label">Datos de identificación de la inspección</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="No_Publicar[]"
                                            value="Contacto de la Autoridad Pública">
                                        <label class="form-check-label">Contacto de la Autoridad Pública</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="No_Publicar[]"
                                            value="Información sobre la inspección">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="No_Publicar[]"
                                            value="Información de la Autoridad Pública">
                        ...
                        <div class="form-step" id="step-9">
                            ...
                            <div id="emergenciaDetails" style="display: none;">
                                <div class="alert alert-info">
                                    <div class="form-group">
                                        <label>Justificar las razones por las cuales se habilita una inspección para atender
                                            una situación de emergencia</label>
                            ...
                            <div class="form-navigation">
                                ...
                                <button type="submit" class="btn" id="submitBtn"
                                    style="display:none;">{{ isset($inspeccion) ? 'Actualizar' : 'Guardar' }}</button>
                            </div>
                    </form>
                </div>
            </div>
