...
<div class="form-group">
  <label>Bien, elemento, objeto o sujeto de inspección, verificación o visita domiciliaria:<span
      class="text-danger">*</span></label>
  <textarea name="Bien_Elemento" class="form-control" rows="2"
    required>{{ $inspeccion->Bien_Elemento ?? '' }}</textarea>
</div>

<div class="form-group">
  <label>Indicar si otros Sujetos Obligados participan en la realización de las inspecciones, verificaciones y visitas
    domiciliarias:<span class="text-danger">*</span></label>
  <select name="Otros_Sujetos_Participan" class="form-control" required>
    <option value="no" {{ !isset($inspeccion) || $inspeccion->Otros_Sujetos_Participan == 'no' ? 'selected' : '' }}>No
    </option>
    <option value="si" {{ isset($inspeccion) && $inspeccion->Otros_Sujetos_Participan == 'si' ? 'selected' : '' }}>Sí
    </option>
  </select>
</div>
...
<div class="form-group" id="sujetosObligados" style="display: none;">
  ...
  <div class="input-group">
    <input type="text" name="Buscar_Sujeto_Obligado" class="form-control" placeholder="Buscar Sujeto Obligado"
      id="buscarSujetosInput">
...
<div id="sujetosModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="sujetosModalLabel"
  aria-hidden="true">
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <div class="input-group-append">
      <button type="button" id="agregarDerechoBtn" class="btn btn-success d-flex align-items-center">
        <i class="fas fa-plus me-2"></i> Agregar Derecho
      </button>
    </div>
  </div>
...
<div id="modalAgregarDerecho" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalAgregarDerechoLabel"
  aria-hidden="true">
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <div class="input-group-append">
      <button type="button" id="agregarObligacionBtn" class="btn btn-success d-flex align-items-center">
        <i class="fas fa-plus me-2"></i> Agregar Obligación
        </button>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modalAgregarObligacion" tabindex="-1" role="dialog"
  aria-labelledby="modalAgregarObligacionLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
    ...
    @endforeach
      @endif
        ...
        <div class="form-group">
          ...
          <input type="text" id="nombreOrdenamientoObligacion" class="form-control"
            placeholder="Nombre del Ordenamiento">
        </div>
...
<!-- Fundamento Jurídico -->
<div class="form-group">
  <label>Fundamento Jurídico de la existencia de la inspección, verificación o visita domiciliaria:<span
      class="text-danger">*</span></label>
  <div class="input-group">
...
<!-- Firmar Formato -->
<div class="form-group">
  <label>Especificar si el sujeto regulado debe llenar o firmar algún formato para la inspección, verificación o visita
