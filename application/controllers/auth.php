...
class Auth extends CI_Controller
{
	...
	*/
	public function redirectUser(){
		...
		$user = $this->ion_auth->user()->row();
		if ($user->id == 1){
			// Redirige al primer usuario a una vista específica
			redirect('home/home_sujeto', 'refresh');
		} elseif ($user->id == 2){
			// Redirige al segundo usuario a una vista diferente
			redirect('home/home_revisor', 'refresh');
		} else {
			// Redirige a todos los demás usuarios a una vista predeterminada
			redirect('ruta/a/vista_predeterminada', 'refresh');
		}
		redirect('/', 'refresh');
	}
