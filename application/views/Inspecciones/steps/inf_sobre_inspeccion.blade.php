<div class="form-step" id="step-3">
    ...
    <div class="form-group"></div>
        ...
        <select name="Otros_Sujetos_Participan" class="form-control" required></select>
    ...
    <div class="form-group" id="sujetosObligados" style="display: none;">
        ...
        <div class="input-group"></div>
            ...
            <div class="input-group-append"></div>
                <button class="btn btn-outline-secondary" type="button" id="buscarSujetosBtn"></button>
    ...
    <div class="form-group"></div>
        ...
        <div class="input-group"></div>
            ...
            <div class="input-group-append"></div>
                <button class="btn btn-outline-secondary" type="button" id="agregarDerechoBtn"></button>
    ...
    <div class="form-group">
        ...
        <select name="Firmar_Formato" class="form-control" required></select>
