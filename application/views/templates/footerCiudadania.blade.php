                        ...
                        <div class="col-12 text-center footer-social-separador-pu">
                            <ul class="list-inline">
                                <li class="list-inline-item"><span class="footer-icon-separador-pu"></span><a
                                        ...
                                        title="Facebook"><i class="fa fa-facebook-official footer-facebook fa-2x"
                                            aria-hidden="true"></a></i></li> <!-- Cambiado de fa-3x a fa-2x -->
                                <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a
                                        href="https://twitter.com/gobiernocolima" target="_blank" title="Twitter"><svg
                                ...
                                <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a
                                        ...
                                        title="Youtube"><i class="fa fa-youtube-play footer-youtube fa-2x"
                                            aria-hidden="true"></a></i></li>
                                <!--
                                <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a
                                        href="http://gobiernocolima.blogspot.mx/" target="_blank" title="Blogspot"><i
                                            class="fa fa-rss-square footer-rss fa-2x" aria-hidden="true"></a></i></li>
                                -->
                                <li class="list-inline-item "><span class="footer-icon-separador-pu"></span><a
                                        href="https://soundcloud.com/gobcolradio/" target="_blank" title="SoundCloud"><i
                                            class="fa fa-soundcloud footer-soundcloud fa-2x" aria-hidden="true"></a></i>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12">
                            <div class="row padding-left-30">
                                ...
                                <div class="col text-center">
                                    <i class="fa fa-qrcode fa-1x" aria-hidden="true"></i><br>
                                ...
                                <div class="col text-center">
                                    <i class="fa fa-check-circle-o fa-1x" aria-hidden="true"></i><br>
                                    <!-- Cambiado de fa-2x a fa-1x -->
                                    <a href="http://www.firel.col.gob.mx/" target="_blank"
